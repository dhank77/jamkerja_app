...
class IjinDetailView extends GetView<IjinDetailController> {
  const IjinDetailView({Key? key}) : super(key: key);
  @override
                    ...
                    DataTable(
                      columns: <DataColumn>[
                        ...
                        DataColumn(
                          label: Expanded(
                            child: Text(
                              controller.data["tanggal_mulai_api"],
                            ),
                          ),
                        ),
                      ],
                          ...
                          cells: <DataCell>[
                            ...
                            DataCell(
                              Padding(
                                ...
                                child: Text(controller.data['mulai']),
                              ),
                            ),
                          ],
                        ),
                        DataRow(
                          cells: <DataCell>[
                            ...
                            DataCell(
                              Padding(
                                padding: const EdgeInsets.only(top: 15.0),
                                child: Text(controller.data['selesai']),
                              ),
                            ),
                          ],
                        ),
